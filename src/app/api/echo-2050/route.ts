...
export async function POST(req: NextRequest) {
  try {
    ...
    const { footprint, data } = body as { footprint: number; data: QuestionnaireData };
    ...
    const prompt = `You are the user's future self, transmitting a message back in time from the year 2050.
